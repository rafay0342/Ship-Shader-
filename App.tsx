...
const AppContent: React.FC = () => {
    ...
    return (
        <div className="h-screen w-screen bg-gray-900 text-white flex flex-col overflow-hidden relative">
             <style>{`
                @keyframes hd-breathing {
                    0%, 100% { 
                        background-color: rgba(255, 255, 255, 0.9);
                        box-shadow: 0 0 8px rgba(0, 255, 255, 0.2), 0 4px 6px -1px rgba(0, 0, 0, 0.1);
                    }
                    50% { 
                        background-color: rgba(215, 255, 255, 1.0);
                        box-shadow: 0 0 16px rgba(0, 255, 255, 0.6), 0 10px 15px -3px rgba(0, 0, 0, 0.1);
                    }
                }
                .hd-active-pulse {
                    animation: hd-breathing 3s ease-in-out infinite;
                }
             `}</style>
            ...
            <div className="fixed top-4 left-4 z-30 flex flex-col gap-2">
                <button
                    ...
                    className={`w-12 h-12 flex items-center justify-center rounded-full transition-all transform hover:scale-110 shadow-lg border backdrop-blur-sm
                                ${isHdEnabled 
                                    ? 'text-black border-cyan-300/50 hd-active-pulse' 
